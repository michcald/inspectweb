...
abstract class App_Instructor_Model_Users
{
    ...
    public static function getStudents($order = null, $limit = null)
    {
        $sdk = self::getSdk();
    ...
    public static function getInstructors($order = null, $limit = null)
    {
        $sdk = self::getSdk();
    ...
    public static function edit($uuid, $firstName, $lastName, $email, $userLevel)
    {
        $sdk = self::getSdk();
